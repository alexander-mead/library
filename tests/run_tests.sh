...
library='-L/usr/local/lib -lfftw3 -lfftw3f -lfftw3l -I/Users/Mead/Physics/library/build /Users/Mead/Physics/library/meadlib -L/Users/Mead/Physics/library'

for i in "${tests[@]}"; do
    i_test=${i}_test
    echo 'Compiling:' $i_test
    $compiler $i_test/$i_test.f90 $normal $slow $library -o $i_test/$i_test.e
    #go $i_test/$i_test.f90
    ./$i_test/$i_test.e
done
