PROGRAM fitting_test
   ...
   ! Choose demo
   WRITE (*, *) 'Choose demo'
   WRITE (*, *) '1 - Demo gradient fit 1'
   WRITE (*, *) '2 - Demo gradient fit 2'
   WRITE (*, *) '3 - Demo grid fit 1'
   WRITE (*, *) '4 - Demo grid fit 2'
   WRITE (*, *) '5 - Demo grid fit 3'
   WRITE (*, *) '6 - Demo quadratic fit 1'
   WRITE (*, *) '7 - Demo adaptive fit 1'
   WRITE (*, *) '8 - Demo adaptive fit 3'
